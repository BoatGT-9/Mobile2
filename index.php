...
<head>
    ...
    <link rel="stylesheet" href="./css/bootstrap/bootstrap.main.css">
</head>
<body>
    ...
    <!-- menu -->
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav"> 
                    ...
                    <li>
                        <a href="phone.php" class="nav-link text-white action_btn">Get Started</a>
                    </li>
                </ul>
            </div>
        <!-- End menu -->
    ...
    <script src="./js/typed.js/typed.min.js.map"></script>
    <!-- <script src="https://unpkg.com/typed.js@2.0.15/dist/typed.umd.js"></script>
    <script>
        var typingEffect = new typed(".text sec-text",{
            String :["Surapong Keaynin"],
            loop : true,
            typeSpeed : 100,
            backSpeed: 80,
            backDelay: 1500
